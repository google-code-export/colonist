...
public class EditorObjExporter : ScriptableObject
{
    ...
    private static string targetFolder
    {
        get
        {
            _targetFolder = EditorUtility.SaveFolderPanel("Save at ..", "", "");
    ...
    [MenuItem("GameObject/Export/Export all MeshFilters in selection to separate OBJs")]
    static void ExportSelectionToSeparate()
    {
        if (!CreateTargetFolder())
            return;
        string targetFolder = EditorObjExporter.targetFolder;
    ...
    [MenuItem("GameObject/Export/Export whole selection to single OBJ")]
    ...
    [MenuItem("GameObject/Export/Export each selected to single OBJ")]
