...
public class GameMenu : MonoBehaviour
{
    ...
    private const float menuHeight = 241.0f;
    private const float menuHeaderHeight = 26.0f;
    private const float buttonWidth = 175.0f;
    private const float buttonHeight = 30.0f;
	
	private bool fullScreenAvailable = false;
	...
	public void Restart ()
	{
        GameMenu instance = (GameMenu)FindObjectOfType(typeof(GameMenu));
		if (instance != null)
		{
